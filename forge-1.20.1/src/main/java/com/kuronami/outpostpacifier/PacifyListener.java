 ...
 *
 * <p>Forge 47 fires {@link MobSpawnEvent.FinalizeSpawn}; this build
 * predates Forge 52's {@code setSpawnCancelled}, so the spawn is
 * suppressed via {@code setResult(Event.Result.DENY)} (FinalizeSpawn
 * is {@code @HasResult}; DENY discards the mob).
 */
